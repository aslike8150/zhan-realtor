 ...
 *
 * 系統擁有者：「為什麼我的 Google 日曆會寫『龍騰建設預約』？好奇怪的名詞。」「跟我預約的顏色我可以選擇嗎？」
    ...
    >
      ...
      {open && (
        <div style={{ marginTop: 14, display: "grid", gap: 14 }}>
          ...
          <div>
            <label style={{ display: "block", color: "#9aa0a6", fontSize: 14, marginBottom: 6 }}>
              預覽（拿假資料「詹衒志·0912345678·公司面談·房仲服務·賣房」套進去）
            </label>
            <div
              style={{
            ...
            >
              {preview}
              <div style={{ fontSize: 13.5, fontWeight: 400, opacity: 0.9, marginTop: 2 }}>16:15，台灣房屋成大東豐店</div>
            </div>
          </div>
