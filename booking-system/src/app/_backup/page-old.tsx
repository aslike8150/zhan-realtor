/**
 * 舊版首頁備份（2026-08-19 換版前的樣子）
 *
 * `_` 開頭的資料夾 Next.js 不會當成路由，所以這個檔不會被連到，純備份。
 * 要退回舊版：把這個檔搬回 src/app/page.tsx、CSS 的 import 改回 "./home.css"。
 */
/**
 * / — 詹衒志個人形象官網（首頁）
 *
        ...
        <section className="hero">
          <div className="container hero__inner">
            <div className="hero__photo-wrap">
              ...
              <img className="hero__photo" src={OWNER.photoUrl} alt={`${OWNER.name} - 台南房仲`} />
            </div>
            <div className="hero__content">
              <p className="eyebrow">
                大台南・{OWNER.company} {OWNER.title}
              </p>
              <h1>{OWNER.name}</h1>
              <p className="hero__tagline">不只是媒合物件，我是您不動產資產的守護者。</p>
              <p className="hero__desc">
                深耕大台南房地產市場，以精準的行情分析與談判策略，陪您從台南買房、資產配置到房地產稅務規劃的每一個環節，做出最有把握的決定。
              </p>
          ...
          <div className="container">
            ...
            <div className="record__grid">
              ...
              <div className="record__card">
                <p className="record__number">大台南</p>
          ...
          <div className="container booking__inner">
            <div className="booking__info">
              ...
              <p className="booking__desc">
                不管是想了解台南買房行情、評估物件，還是想聊聊資產配置與房地產稅務諮詢，線上挑一個你方便的時段就好，不用來回敲時間。
              </p>
