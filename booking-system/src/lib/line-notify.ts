/**
 * 房仲日常 bot(@mrbin)推「衒志官方 Line AI 客服機器人」admin 群 — HITL 接手通知用
 *
 * 2026-06-04: HITL 通知必須走房仲日常 bot 推衒志監控群(龍騰建設 bot 不在那群,所以不能用 notifyLineGroup)。
 ...
 * 龍騰建設 bot 不在這個群組，admin 通知不得改走 LINE_CHANNEL_* token。
 */
